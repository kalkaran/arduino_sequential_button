 ...
 *    This should display the storage devices and contain something like the following which is the SD card:
 *
 ...
 *
 *    The disk number is 4 so we need to set this on the next command:
...
int songIndex = 0;        // Index for the current song, starts at 0
int totalSongs = 0;       // Total number of songs on the SD card
int buttonState = 0;      // Current state of the button

SoftwareSerial mySoftwareSerial(10, 11); // RX, TX for SoftwareSerial communication
...
void setup()
{  
Here are the improved comments for your code:
